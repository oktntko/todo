...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    '/': RouteRecordInfo<'/', '/', Record<never, never>, Record<never, never>, '//' | '//chat' | '//drive/' | '//mypage' | '//mypage/' | '//mypage/account' | '//mypage/change-password' | '//mypage/chat' | '//mypage/security' | '//todo/board' | '//todo/calendar' | '//todo/list' | '//todo/table/' | '//todo/table/[todo_id]' | '//todo/table/add'>,
  ...
  export interface _RouteFileInfoMap {
    'src/page/index.vue': {
      routes: '/' | '//' | '//mypage/' | '//drive/' | '//todo/table/' | '//todo/table/[todo_id]' | '//mypage/account' | '//todo/table/add' | '//todo/board' | '//todo/calendar' | '//mypage/change-password' | '//chat' | '//mypage/chat' | '//drive' | '//todo/list' | '//mypage' | '//mypage/security' | '//todo/table' | '//todo'
      views: 'default'
    }
