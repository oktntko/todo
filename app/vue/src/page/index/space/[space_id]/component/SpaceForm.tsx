...
export default defineComponent(
      ...
      >
        <section class="flex flex-col gap-3">
          <div class="flex gap-6">
              ...
              {modelValue.value.space_image ? (
                ...
                <div class="relative h-16 w-16">
                  ...
                  <button
                    ...
                    aria-label="Close"
                    onClick={() => (modelValue.value.space_image = '')}
                  >
            ...
            <div class="focus-container flex flex-col gap-0.5">
              <div>
                <label for="space_color" class="text-sm capitalize">
                  color
                </label>
              </div>
              ...
              <div class="grow">
                <MyInput
                  id="space_color"
                  v-model={modelValue.value.space_color}
                  list="color-picker"
                  type="color"
  ...
  },
  {
    props,
    emits,
    slots: {} as SlotsType<SpaceFormSlots>,
  },
);
