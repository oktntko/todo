...
import DynamicTodoForm from './DynamicTodoForm.vue';
...
export type TodoWithStatus = RouterOutput['todo']['get'] & { editing?: boolean };
...
function createNewEmptyTodo(): Promise<TodoWithStatus> {
    ...
    <div class="sticky top-0 z-10 bg-white pt-4 pb-2">
      ...
      <div class="flex flex-row items-center gap-2 ps-2 pe-4 text-sm">
        <button
          ...
          @click="
            async () => {
              todo_list.unshift(await createNewEmptyTodo());
            }
          "
        >
