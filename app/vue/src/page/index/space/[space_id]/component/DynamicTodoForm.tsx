...
export type ModelValue = z.infer<typeof TodoRouterSchema.applyChangeInput> & {
  editing?: boolean;
  updated_at: Date;
};
...
const { validateSubmit } = useVueValidateZod(TodoRouterSchema.applyChangeInput, modelValue);
