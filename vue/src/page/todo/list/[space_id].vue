...
<template>
  <div class="px-4 flex flex-row gap-2 mb-8">
    <div
      class="container text-sm max-w-2xl self-start bg-white rounded border pb-4 border-gray-300"
    >
      <Transition
        mode="out-in"
      ...
      >
        <div v-if="space">
                    ...
                    <button
                      ...
                      @click="
                        async () => {
                          ...
                          if (
                            !(await $dialog.confirm('This action cannot be undone. Are you sure?'))
                          )
                            return;
          ...
          <div class="flex flex-row gap-2 items-center text-sm px-4">
            <button
              type="button"
